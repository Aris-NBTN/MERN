      ...
      !function (t) {
        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
          n = l(l({}, {
            ...
            onEvent: 0,
            onEventAfter: function onEventAfter(t) {
        ...
        if (!m && o) {
          ...
          }(Array.isArray(r) ? c(r) : [r]), function t(e) {
            if (e.length) {
        ...
        t.DomComponents.addType(s, {
          ...
          applyChanges: function applyChanges(t) {
            var e = this.target,
              n = this.editor;
            if (i) i(t);else {
